...
!(function (e, t) {
    ...
    function e(e) {
        ...
        return !(t.right > window.innerWth || t.bottom > window.innerHeight) && !(t.top < 0 || t.left < 0);
    }
    function t(e, t) {
            ...
            return (
                r(s, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            this.checkElement(),
                                ...
                                (this.options.strings.length >= 1 && "" === this.options.strings[0]) ||
                                    ...
                                    this.options.startDelete && (this.insert(this.stringsToDelete), this.queue.push([this.delete]), this.insertSplitPause(1)),
                                    this.cursor(),
                                    this.generateQueue(),
                                    this.kickoff());
                        },
                        ...
                        value: function () {
                            ...
                            (t = null === t ? [this.pause, this.options.startDelay] : t),
                                ...
                                this.options.strings.forEach(function (t, n) {
                                    e.queueString(t),
                                        n + 1 < e.options.strings.length && (e.options.breakLines ? (e.queue.push([e.break]), e.insertSplitPause(e.queue.length)) : (e.queueDeletions(t), e.insertSplitPause(e.queue.length, t.length)));
                                });
                        },
                    },
                    {
                        key: "queueDeletions",
                        value: function () {
                            for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null, t = "string" == typeof e ? e.length : e, n = 0; n < t; n++) this.queue.push([this.delete, 1]);
                        },
                    },
                    {
                        key: "queueString",
                        value: function (e) {
                            ...
                            if (e) {
                                if (((e = i(e)), (document.implementation.createHTMLDocument("").body.innerHTML = e), t && (e = (e = this.rake(e))[0]), this.options.html && n(e[0], "<") && !n(e[0], "</"))) {
                                    var s = e[0].match(/\<(.*?)\>/),
                                        o = document.implementation.createHTMLDocument("");
                                    (o.body.innerHTML = "<" + s[1] + "></" + s[1] + ">"), this.queue.push([this.type, o.body.children[0]]);
                    ...
                    },
                    {
                        key: "kickoff",
                        value: function () {
                            if (this.options.autoStart) return (this.hasStarted = !0), void this.next();
                            if (e(this.element)) return (this.hasStarted = !0), void this.next();
                            var t = this;
                            window.addEventListener("scroll", function n(i) {
                                e(t.element) && !t.hasStarted && ((t.hasStarted = !0), t.next(), i.currentTarget.removeEventListener(i.type, n));
                            });
                        },
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (this.options.cursor) {
                                ...
                                var n =
                                    ...
                                    "s infinite;\n            }\n          ";
                                t.appendChild(document.createTextNode(n)), document.head.appendChild(t), (e = "");
                            }
                            this.element.insertAdjacentHTML("beforeend", '<span style="' + this.style + e + '" class="ti-cursor">' + this.options.cursorChar + "</span>");
                        },
                    },
                    {
                        key: "insert",
                        value: function (e) {
                            arguments.length > 1 && void 0 !== arguments[1] && arguments[1] ? this.elementContainer.lastChild.insertAdjacentHTML("beforeend", e) : this.elementContainer.insertAdjacentHTML("beforeend", e),
                            ...
                            return e.map(function (e) {
                                if (((e = e.split("")), t.options.html))
                                    for (var n = [], i = void 0, s = !1, o = 0; o < e.length; o++)
                                        ("<" !== e[o] && "&" !== e[o]) || ((n[0] = o), (s = "&" === e[o])),
                                            (">" === e[o] || (";" === e[o] && s)) && ((n[1] = o), (o = 0), (i = e.slice(n[0], n[1] + 1).join("")), e.splice(n[0], n[1] - n[0] + 1, i), (s = !1));
                                return e;
                            });
                        },
                    },
                            ...
                            this.setPace(),
                                (this.timeouts[0] = setTimeout(function () {
                                    return "string" != typeof e
                                        ? ((e.innerHTML = ""), t.elementContainer.appendChild(e), (t.isInTag = !0), void t.next())
                                        : n(e, "</")
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e = this.options.speed,
                                n = void 0 !== this.options.deleteSpeed ? this.options.deleteSpeed : this.options.speed / 3,
                                i = e / 2,
                                s = n / 2;
                            (this.typePace = this.options.lifeLike ? t(e, i) : e), (this.deletePace = this.options.lifeLike ? t(n, s) : n);
                        },
                    },
                    {
                        key: "delete",
                        value: function () {
                            ...
                            this.timeouts[1] = setTimeout(function () {
                                e.setPace();
                                for (var n = e.elementContainer.innerHTML.split(""), i = n.length - 1; i > -1; i--) {
                                ...
                                if (e.elementContainer.innerHTML.indexOf("></") > -1)
                                    for (var r = e.elementContainer.innerHTML.indexOf("></") - 2; r >= 0; r--)
                                        if ("<" === n[r]) {
                                            n.splice(r, n.length - r);
                                            break;
                                        }
                                (e.elementContainer.innerHTML = n.join("").replace(/<[^\/>][^>]*><\/[^>]+>/, "")), null === t && e.queue.unshift([e.delete, n.length]), t > 1 && e.queue.unshift([e.delete, t - 1]), e.next();
                            }, this.deletePace);
                        },
                    },
                    {
    ...
    return (function () {
        function e(t, n) {
            o(this, e),
                ...
                (this.elements = []),
                (this.args = n),
                "object" === (void 0 === t ? "undefined" : s(t)) && (void 0 === t.length ? this.elements.push(t) : (this.elements = t)),
                    ...
                    value: function () {
                        ...
                        this.instances.forEach(function (t) {
                            (t.timeouts = t.timeouts.map(function (e) {
                                ...
                                e && t.element.removeChild(t.element.querySelector(".ti-cursor"));
                        }),
                            (this.instances = []);
                    },
                },
